(function(){
  const DAILY_KEY="kobotrade_daily_check_date_test_v24";
  ...
  window.kobotradeShowNotification=async function(t,b){
    ...
    try{
      ...
      if(reg&&reg.showNotification){
        await reg.showNotification(t,{body:b,tag:"kobotrade-buy-v24",renotify:true});
        return true;
      }
    }catch(e){console.warn("showNotification",e)}
    try{new Notification(t,{body:b,tag:"kobotrade-buy-v24"});return true}catch(e){return false}
  };
